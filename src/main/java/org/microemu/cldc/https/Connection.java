...
public class Connection extends org.microemu.cldc.http.Connection implements HttpsConnection {
     ...
     *
     * @return the network port number of the URL for this HttpsConnection. The
     * default HTTPS port number (443) is returned if there was no port number
     * in the string passed to Connector.open.
     */
    public int getPort() {
        if (cn == null) {
            return -1;
