 ...
 * {@link #getStringAttribute(String) getStringAttribute}. The following example
 * shows how to list the attributes of an element:
 * <UL>
 * <CODE>
...
public class XMLElement {
     ...
     * </dl>
     *
     * @see XMLElement#XMLElement(Hashtable) XMLElement(Hashtable)
     * @see XMLElement#XMLElement(boolean)
     * @see XMLElement#XMLElement(Hashtable,boolean) XMLElement(Hashtable,
     * boolean)
     */
    public XMLElement() {
     ...
     * @see XMLElement#getAttribute(String, Hashtable, String, boolean)
     ...
     * @see XMLElement#getStringAttribute(String, Hashtable, String, boolean)
     ...
     * @see XMLElement#getIntAttribute(String, Hashtable, String, boolean)
     ...
     * @see XMLElement#getDoubleAttribute(String, Hashtable, String, boolean)
     ...
     * @param valueSet Hashtable mapping keys to values.
     * @param defaultKey Key to use if the attribute is missing.
     * @param allowLiteralNumbers <code>true</code> if literal numbers are
     * valid.
     *
     * </dl>
     * <dl>
     ...
     * <P>
     * As an example, if valueSet contains the mapping <code>"one" =&gt;
     * 1.0</code> and the element contains the attribute
     * <code>attr="one"</code>, then
     ...
     *             Hashtable, String, boolean) getAttribute} instead.
     */
     ...
     * @throws XMLParseException If an error occured while parsing the read
     * data.
     */
     ...
     *
     * @see XMLElement#write(Writer) write(Writer)
     */
